...
class Wdc_Cartex_Adminhtml_IndexController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        $this->loadLayout()
            ...
            ->_addBreadcrumb(Mage::helper('cartex')->__('Options Rule'), Mage::helper('cartex')->__('Options Rule'))
        ;
        return $this;
    }  
    ...
    public function editAction()
    {
        ...
        $model = Mage::getModel('cartex/template');
        ...
        Mage::register('current_promoentity_template', $model);
    ...
    public function gridOnlyAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('cartex/entity_edit_tab_' . $this->getRequest()->getParam('gridOnlyBlock'))
                ->toHtml()
        );
    }    
    ...
    {
        return $this->getLayout()->createBlock('cartex/entity_edit_tab_ajax_serializer')
