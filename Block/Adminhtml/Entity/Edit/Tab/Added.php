...
class Wdc_Cartex_Block_Adminhtml_Entity_Edit_Tab_Added extends Mage_Adminhtml_Block_Widget_Grid
{
	public function __construct()
	{
		parent::__construct();
		$this->setId('added_product_grid');
		$this->setDefaultSort('entity_id');
		$this->setUseAjax(true);		
		//$iTemplateId = Mage::app()->getFrontController()->getRequest()->get('id');		
	}
	...
	protected function _prepareCollection()
	{
		...
		$collection->getSelect()->where('e.type_id = "simple" OR att.value = 1');
	...
	{
		return $this->getData('grid_url') ? $this->getData('grid_url') : $this->getUrl('*/*/added', array('_current'=>true));
	}
	...
	protected function _getSelectedProducts()
	{
		...
		if (!is_array($products)) {			
			...
			$products = $cartexProducts->fetchbyAttributeId($cartexId);
		}
		return $products;
	}
