...
class Wdc_Cartex_Block_Adminhtml_Entity_Edit_Tab_Buyxfree extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
		...
		$fieldset->addField('min_val', 'text', array(
			'name'      => 'min_val',
			'label'     => $hlp->__('Minimum Qualifying Qty'),
		...
		$fieldset->addField('max_val', 'text', array(
			'name'      => 'max_val',
			'label'     => $hlp->__('Maximum Qualifying Qty'),
			'class'     => 'validate-number',
			'required'  => true,
			));	
