...
class Wdc_Cartex_Block_Adminhtml_Entity_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
	public function __construct()
	{
		parent::__construct();
		$this->setId('grouped_product_grid');
	...
	{
		return $this->getData('grid_url') ? $this->getData('grid_url') : $this->getUrl('*/*/products', array('_current'=>true));
	}
