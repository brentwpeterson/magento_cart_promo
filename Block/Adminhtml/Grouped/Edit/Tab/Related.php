...
class Wdc_Cartex_Block_Adminhtml_Grouped_Edit_Tab_Related extends Mage_Adminhtml_Block_Widget_Grid
{
...
####            'edit_only' => !$this->_getProduct()->getId()
    ...
    protected function _getSelectedProducts()
    {
        ...
        if (!is_array($products)) {
            ...
            $FaqId = Mage::app()->getFrontController()->getRequest()->get('id');
            
        	$faqproducts = Mage::getResourceModel('faq/entity');
			$products = $faqproducts->getFaqProducts($FaqId);
        }
        return $products;
    }
