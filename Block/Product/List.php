...
class Wdc_Cartex_Block_Product_List extends Wdc_Cartex_Block_Entity
{	
	...
	{
		$promo = Mage::getModel('cartex/cart_entity')->load($this->setPromoId());
	...
	{
		return '/cartex/index/add/promoid/'.$this->getPromoId().'./';	
	}
